    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class payment(
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["terminal", "methodId", "order", "amount", "currency", "originalIp", "idUser", "tokenUser", "secure", "scoring", "productDescription", "merchantDescriptor", "userInteraction", "trxType", "scaException", "urlOk", "urlKo", "notifyDirectPayment", "merchantData", ], str]):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["terminal", "methodId", "order", "amount", "currency", "originalIp", "idUser", "tokenUser", "secure", "scoring", "productDescription", "merchantDescriptor", "userInteraction", "trxType", "scaException", "urlOk", "urlKo", "notifyDirectPayment", "merchantData", ], str]):
                    return super().get_item_oapg(name)
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["errorCode", "amount", "currency", "methodId", "order", "authCode", "challengeUrl", "idUser", "tokenUser", "cardCountry", "subscription", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["errorCode", "amount", "currency", "methodId", "order", "authCode", "challengeUrl", "idUser", "tokenUser", "cardCountry", "subscription", ], str]):
        return super().get_item_oapg(name)
