...
class SchemaForRequestBodyApplicationJson(
                        ...
                        class shipping(
                            ...
                            class MetaOapg:
                                ...
                                class properties:
                                    ...
                                    shipAddrCountry = schemas.IntSchema
                            ...
                            def __new__(
                                ...
                                *_args: typing.Union[dict, frozendict.frozendict, ],
                                ...
                                shipAddrCountry: typing.Union[MetaOapg.properties.shipAddrCountry, decimal.Decimal, int, schemas.Unset] = schemas.unset,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["periodicity"]) -> MetaOapg.properties.periodicity: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["terminal", "order", "amount", "currency", "methodId", "originalIp", "secure", "language", "smsEmail", "templateId", "emailAddress", "emailName", "smsPrefix", "smsNumber", "expiryDate", "expiryHour", "expiryMinute", "scoring", "startDate", "endDate", "periodicity", "merchantData", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["periodicity"]) -> typing.Union[MetaOapg.properties.periodicity, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["terminal", "order", "amount", "currency", "methodId", "originalIp", "secure", "language", "smsEmail", "templateId", "emailAddress", "emailName", "smsPrefix", "smsNumber", "expiryDate", "expiryHour", "expiryMinute", "scoring", "startDate", "endDate", "periodicity", "merchantData", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        periodicity: typing.Union[MetaOapg.properties.periodicity, str, schemas.Unset] = schemas.unset,
...
class LaunchSubscription(BaseApi):
    ...
    def launch_subscription(
        ...
        return self._launch_subscription_oapg(
            body=body,
