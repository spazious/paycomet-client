...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["errorCode", "ivrResponse", "ivrSessionState", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["errorCode", "ivrResponse", "ivrSessionState", ], str]):
        return super().get_item_oapg(name)
...
class SessionCancel(BaseApi):
    ...
    def session_cancel(
        ...
        return self._session_cancel_oapg(
            body=body,
