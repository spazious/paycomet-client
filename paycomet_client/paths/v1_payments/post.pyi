    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class payment(
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["terminal", "order", "amount", "currency", "methodId", "originalIp", "secure", "idUser", "tokenUser", "scoring", "productDescription", "merchantDescriptor", "userInteraction", "trxType", "scaException", "urlOk", "urlKo", "notifyDirectPayment", "tokenize", "merchantData", ], str]):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["terminal", "order", "amount", "currency", "methodId", "originalIp", "secure", "idUser", "tokenUser", "scoring", "productDescription", "merchantDescriptor", "userInteraction", "trxType", "scaException", "urlOk", "urlKo", "notifyDirectPayment", "tokenize", "merchantData", ], str]):
                    return super().get_item_oapg(name)
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["methodData"]) -> MetaOapg.properties.methodData: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["errorCode", "amount", "currency", "methodId", "order", "authCode", "challengeUrl", "idUser", "tokenUser", "cardCountry", "methodData", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["methodData"]) -> typing.Union[MetaOapg.properties.methodData, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["errorCode", "amount", "currency", "methodId", "order", "authCode", "challengeUrl", "idUser", "tokenUser", "cardCountry", "methodData", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        methodData: typing.Union[MetaOapg.properties.methodData, list, tuple, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
...
class ExecutePurchase(BaseApi):
    ...
    def execute_purchase(
        ...
        return self._execute_purchase_oapg(
            body=body,
