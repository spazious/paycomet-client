            ...
            class payment(
                ...
                class MetaOapg:
                    ...
                    class properties:
                        ...
                        merchantIdentifier = schemas.StrSchema
                        merchantGroup = schemas.StrSchema
                ...
                merchantIdentifier: MetaOapg.properties.merchantIdentifier
                ...
                @typing.overload
                def __getitem__(self, name: typing_extensions.Literal["merchantGroup"]) -> MetaOapg.properties.merchantGroup: ...
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["terminal", "order", "amount", "currency", "methodId", "originalIp", "secure", "merchantIdentifier", "merchantGroup", "scoring", "productDescription", "merchantDescriptor", "userInteraction", "trxType", "scaException", "urlOk", "urlKo", "notifyDirectPayment", "merchantData", ], str]):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                ...
                @typing.overload
                def get_item_oapg(self, name: typing_extensions.Literal["merchantIdentifier"]) -> MetaOapg.properties.merchantIdentifier: ...
                
                @typing.overload
                def get_item_oapg(self, name: typing_extensions.Literal["merchantGroup"]) -> typing.Union[MetaOapg.properties.merchantGroup, schemas.Unset]: ...
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["terminal", "order", "amount", "currency", "methodId", "originalIp", "secure", "merchantIdentifier", "merchantGroup", "scoring", "productDescription", "merchantDescriptor", "userInteraction", "trxType", "scaException", "urlOk", "urlKo", "notifyDirectPayment", "merchantData", ], str]):
                    return super().get_item_oapg(name)
                ...
                def __new__(
                    cls,
                    *_args: typing.Union[dict, frozendict.frozendict, ],
                    merchantIdentifier: typing.Union[MetaOapg.properties.merchantIdentifier, str, ],
                    ...
                    merchantGroup: typing.Union[MetaOapg.properties.merchantGroup, str, schemas.Unset] = schemas.unset,
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["errorCode", "amount", "currency", "methodId", "order", "authCode", "challengeUrl", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["errorCode", "amount", "currency", "methodId", "order", "authCode", "challengeUrl", ], str]):
        return super().get_item_oapg(name)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_preauthorization_rtoken_oapg(
        self,
...
class CreatePreauthorizationRtoken(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_preauthorization_rtoken(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        header_params: RequestHeaderParams = frozendict.frozendict(),
    ...
    def create_preauthorization_rtoken(
        ...
        return self._create_preauthorization_rtoken_oapg(
            body=body,
