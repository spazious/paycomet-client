...
class SchemaForRequestBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class payment(
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["terminal", "order", "tokenUser", "idUser", "originalIp", "amount", "scoring", "productDescription", "merchantDescriptor", "userInteraction", "trxType", "scaException", "urlOk", "urlKo", "merchantData", ], str]):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["terminal", "order", "tokenUser", "idUser", "originalIp", "amount", "scoring", "productDescription", "merchantDescriptor", "userInteraction", "trxType", "scaException", "urlOk", "urlKo", "merchantData", ], str]):
                    return super().get_item_oapg(name)
    ...
    idUser: schemas.AnyTypeSchema
    amount: schemas.AnyTypeSchema
    terminal: schemas.AnyTypeSchema
    tokenUser: schemas.AnyTypeSchema
    originalIp: schemas.AnyTypeSchema
    ...
    def __new__(
        cls,
        *_args: typing.Union[dict, frozendict.frozendict, ],
        idUser: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        ...
        terminal: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        tokenUser: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        originalIp: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
...
class SchemaFor200ResponseBodyApplicationJson(
            ...
            class dcc(
                ...
                class MetaOapg:
                    ...
                    class properties:
                        ...
                        exchange = schemas.NumberSchema
                        amount = schemas.StrSchema
                        date = schemas.StrSchema
                        markup = schemas.NumberSchema
                        __annotations__ = {
                            "session": session,
                            "currency": currency,
                ...
                @typing.overload
                def __getitem__(self, name: typing_extensions.Literal["markup"]) -> MetaOapg.properties.markup: ...
                
                @typing.overload
                def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
                
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["session", "currency", "currencyIso3", "currencyName", "exchange", "amount", "date", "markup", ], str]):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                ...
                @typing.overload
                def get_item_oapg(self, name: typing_extensions.Literal["markup"]) -> typing.Union[MetaOapg.properties.markup, schemas.Unset]: ...
                
                @typing.overload
                def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
                
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["session", "currency", "currencyIso3", "currencyName", "exchange", "amount", "date", "markup", ], str]):
                    return super().get_item_oapg(name)
                ...
                def __new__(
                    ...
                    *_args: typing.Union[dict, frozendict.frozendict, ],
                    ...
                    exchange: typing.Union[MetaOapg.properties.exchange, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
                    amount: typing.Union[MetaOapg.properties.amount, str, schemas.Unset] = schemas.unset,
                    date: typing.Union[MetaOapg.properties.date, str, schemas.Unset] = schemas.unset,
                    markup: typing.Union[MetaOapg.properties.markup, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
                    _configuration: typing.Optional[schemas.Configuration] = None,
                    **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
                ) -> 'dcc':
                    return super().__new__(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["dcc"]) -> MetaOapg.properties.dcc: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["errorCode", "amount", "currency", "methodId", "order", "authCode", "challengeUrl", "idUser", "tokenUser", "cardCountry", "dcc", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["dcc"]) -> typing.Union[MetaOapg.properties.dcc, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["errorCode", "amount", "currency", "methodId", "order", "authCode", "challengeUrl", "idUser", "tokenUser", "cardCountry", "dcc", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        dcc: typing.Union[MetaOapg.properties.dcc, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
...
class DccPurchaseCreate(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def dcc_purchase_create(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        header_params: RequestHeaderParams = frozendict.frozendict(),
    ...
    def dcc_purchase_create(
        ...
        return self._dcc_purchase_create_oapg(
            body=body,
