...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["currency", "order", "amount", "errorCode", "cardCountry", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["currency", "order", "amount", "errorCode", "cardCountry", ], str]):
        return super().get_item_oapg(name)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _cancel_preauthorization_oapg(
        self,
...
class CancelPreauthorization(BaseApi):
    ...
    def cancel_preauthorization(
        ...
        return self._cancel_preauthorization_oapg(
            body=body,
