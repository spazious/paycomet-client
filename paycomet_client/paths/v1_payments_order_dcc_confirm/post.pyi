...
class SchemaForRequestBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class payment(
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["terminal", "order", "amount", "currency", "methodId", "originalIp", "secure", "idUser", "tokenUser", "scoring", "productDescription", "merchantDescriptor", "userInteraction", "trxType", "scaException", "urlOk", "urlKo", "notifyDirectPayment", "merchantData", ], str]):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["terminal", "order", "amount", "currency", "methodId", "originalIp", "secure", "idUser", "tokenUser", "scoring", "productDescription", "merchantDescriptor", "userInteraction", "trxType", "scaException", "urlOk", "urlKo", "notifyDirectPayment", "merchantData", ], str]):
                    return super().get_item_oapg(name)
                ...
                def __new__(
                    ...
                    *_args: typing.Union[dict, frozendict.frozendict, ],
                    ...
                    methodId: typing.Union[MetaOapg.properties.methodId, str, schemas.Unset] = schemas.unset,
                    ...
                    idUser: typing.Union[MetaOapg.properties.idUser, str, schemas.Unset] = schemas.unset,
            ...
            class dcc(
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["currency", "session", ], str]):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["currency", "session", ], str]):
                    return super().get_item_oapg(name)
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["payment", "dcc", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["dcc"]) -> MetaOapg.properties.dcc: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["payment", "dcc", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        cls,
        *_args: typing.Union[dict, frozendict.frozendict, ],
        dcc: typing.Union[MetaOapg.properties.dcc, dict, frozendict.frozendict, ],
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["amount", "order", "currency", "authCode", "cardCountry", "challengeUrl", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["amount", "order", "currency", "authCode", "cardCountry", "challengeUrl", ], str]):
        return super().get_item_oapg(name)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _dcc_purchase_confirm_oapg(
        self,
...
class DccPurchaseConfirm(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def dcc_purchase_confirm(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        header_params: RequestHeaderParams = frozendict.frozendict(),
    ...
    def dcc_purchase_confirm(
        ...
        return self._dcc_purchase_confirm_oapg(
            body=body,
