    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class payment(
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["terminal", "amount", "currency", "authCode", "originalIp", "tokenUser", "idUser", "notifyDirectPayment", ], str]):
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["terminal", "amount", "currency", "authCode", "originalIp", "tokenUser", "idUser", "notifyDirectPayment", ], str]):
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["errorCode", "amount", "currency", "methodId", "order", "authCode", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["errorCode", "amount", "currency", "methodId", "order", "authCode", ], str]):
        return super().get_item_oapg(name)
...
class ExecuteRefund(BaseApi):
    ...
    def execute_refund(
        ...
        return self._execute_refund_oapg(
            body=body,
