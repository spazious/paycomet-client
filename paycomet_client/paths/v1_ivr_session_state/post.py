...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["terminal", "ivrProviderId", "ivrMerchantOrder", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["terminal", "ivrProviderId", "ivrMerchantOrder", ], str]):
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            ivrSessionState = schemas.IntSchema
            ivrSessionResult = schemas.IntSchema
            ivrTimeLeft = schemas.IntSchema
            ivrDigitPan = schemas.IntSchema
            ivrDigitExp = schemas.IntSchema
            ivrDigitCvc = schemas.IntSchema
            __annotations__ = {
                "errorCode": errorCode,
                "ivrResponse": ivrResponse,
                "ivrSessionState": ivrSessionState,
                "ivrSessionResult": ivrSessionResult,
                "ivrTimeLeft": ivrTimeLeft,
                "ivrDigitPan": ivrDigitPan,
                "ivrDigitExp": ivrDigitExp,
                "ivrDigitCvc": ivrDigitCvc,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ivrSessionState"]) -> MetaOapg.properties.ivrSessionState: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ivrSessionResult"]) -> MetaOapg.properties.ivrSessionResult: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ivrTimeLeft"]) -> MetaOapg.properties.ivrTimeLeft: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ivrDigitPan"]) -> MetaOapg.properties.ivrDigitPan: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ivrDigitExp"]) -> MetaOapg.properties.ivrDigitExp: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ivrDigitCvc"]) -> MetaOapg.properties.ivrDigitCvc: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["errorCode", "ivrResponse", "ivrSessionState", "ivrSessionResult", "ivrTimeLeft", "ivrDigitPan", "ivrDigitExp", "ivrDigitCvc", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ivrSessionState"]) -> typing.Union[MetaOapg.properties.ivrSessionState, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ivrSessionResult"]) -> typing.Union[MetaOapg.properties.ivrSessionResult, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ivrTimeLeft"]) -> typing.Union[MetaOapg.properties.ivrTimeLeft, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ivrDigitPan"]) -> typing.Union[MetaOapg.properties.ivrDigitPan, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ivrDigitExp"]) -> typing.Union[MetaOapg.properties.ivrDigitExp, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ivrDigitCvc"]) -> typing.Union[MetaOapg.properties.ivrDigitCvc, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["errorCode", "ivrResponse", "ivrSessionState", "ivrSessionResult", "ivrTimeLeft", "ivrDigitPan", "ivrDigitExp", "ivrDigitCvc", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        ivrSessionState: typing.Union[MetaOapg.properties.ivrSessionState, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        ivrSessionResult: typing.Union[MetaOapg.properties.ivrSessionResult, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        ivrTimeLeft: typing.Union[MetaOapg.properties.ivrTimeLeft, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        ivrDigitPan: typing.Union[MetaOapg.properties.ivrDigitPan, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        ivrDigitExp: typing.Union[MetaOapg.properties.ivrDigitExp, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        ivrDigitCvc: typing.Union[MetaOapg.properties.ivrDigitCvc, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
...
class CheckSession(BaseApi):
    ...
    def check_session(
        ...
        return self._check_session_oapg(
            body=body,
