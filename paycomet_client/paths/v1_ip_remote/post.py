...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            remoteAddress = schemas.IntSchema
            __annotations__ = {
                "errorCode": errorCode,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["errorCode", "remoteAddress", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["errorCode", "remoteAddress", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        remoteAddress: typing.Union[MetaOapg.properties.remoteAddress, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
...
class GetRemoteAddress(BaseApi):
    ...
    def get_remote_address(
        ...
        return self._get_remote_address_oapg(
            body=body,
