...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["idUser", "tokenUser", "terminal", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["idUser", "tokenUser", "terminal", ], str]):
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            cardICountryISO3 = schemas.StrSchema
            expiryDate = schemas.StrSchema
            cardHash = schemas.StrSchema
            cardCategory = schemas.StrSchema
            sepaCard = schemas.IntSchema
            psd2Card = schemas.StrSchema
            tokenCOF = schemas.IntSchema
            eeaCard = schemas.StrSchema
            errorCode = schemas.IntSchema
            __annotations__ = {
                "pan": pan,
                "cardBrand": cardBrand,
                "cardType": cardType,
                "cardICountryISO3": cardICountryISO3,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["cardICountryISO3"]) -> MetaOapg.properties.cardICountryISO3: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["expiryDate"]) -> MetaOapg.properties.expiryDate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["cardHash"]) -> MetaOapg.properties.cardHash: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["cardCategory"]) -> MetaOapg.properties.cardCategory: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["sepaCard"]) -> MetaOapg.properties.sepaCard: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["psd2Card"]) -> MetaOapg.properties.psd2Card: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["tokenCOF"]) -> MetaOapg.properties.tokenCOF: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["eeaCard"]) -> MetaOapg.properties.eeaCard: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["pan", "cardBrand", "cardType", "cardICountryISO3", "expiryDate", "cardHash", "cardCategory", "sepaCard", "psd2Card", "tokenCOF", "eeaCard", "errorCode", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["cardICountryISO3"]) -> typing.Union[MetaOapg.properties.cardICountryISO3, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["cardHash"]) -> typing.Union[MetaOapg.properties.cardHash, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["sepaCard"]) -> typing.Union[MetaOapg.properties.sepaCard, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["psd2Card"]) -> typing.Union[MetaOapg.properties.psd2Card, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["tokenCOF"]) -> typing.Union[MetaOapg.properties.tokenCOF, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["eeaCard"]) -> typing.Union[MetaOapg.properties.eeaCard, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["pan", "cardBrand", "cardType", "cardICountryISO3", "expiryDate", "cardHash", "cardCategory", "sepaCard", "psd2Card", "tokenCOF", "eeaCard", "errorCode", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        cardICountryISO3: typing.Union[MetaOapg.properties.cardICountryISO3, str, schemas.Unset] = schemas.unset,
        expiryDate: typing.Union[MetaOapg.properties.expiryDate, str, schemas.Unset] = schemas.unset,
        cardHash: typing.Union[MetaOapg.properties.cardHash, str, schemas.Unset] = schemas.unset,
        cardCategory: typing.Union[MetaOapg.properties.cardCategory, str, schemas.Unset] = schemas.unset,
        sepaCard: typing.Union[MetaOapg.properties.sepaCard, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        psd2Card: typing.Union[MetaOapg.properties.psd2Card, str, schemas.Unset] = schemas.unset,
        tokenCOF: typing.Union[MetaOapg.properties.tokenCOF, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        eeaCard: typing.Union[MetaOapg.properties.eeaCard, str, schemas.Unset] = schemas.unset,
