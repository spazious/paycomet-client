<a name="__pageTop"></a>
# paycomet_client.apis.tags.exchange_api.ExchangeApi

All URIs are relative to *https://rest.paycomet.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**exchange**](#exchange) | **post** /v1/exchange | Converts a certain amount from a currency to another.

# **exchange**
<a name="exchange"></a>
> {str: (bool, date, datetime, dict, float, int, list, str, none_type)} exchange()
...
from paycomet_client.apis.tags import exchange_api
...
------------ | ------------- | ------------- | ------------- | -------------
**amount** | str,  | str,  | Amount to convert | 
**finalCurrency** | str,  | str,  | Currency to convert to | 
**terminal** | decimal.Decimal, int,  | decimal.Decimal,  | Product or terminal Id. | 
**originalCurrency** | str,  | str,  | Currency to convert from | 
...
200 | [ApiResponseFor200](#exchange.ApiResponseFor200) | OK
403 | [ApiResponseFor403](#exchange.ApiResponseFor403) | Not Allowed
422 | [ApiResponseFor422](#exchange.ApiResponseFor422) | Unprocessable Entity

#### exchange.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
...
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**amount** | str,  | str,  | Amount in requested currency | [optional] 
**errorCode** | decimal.Decimal, int,  | decimal.Decimal,  |  | [optional] 
**any_string_name** | dict, frozendict.frozendict, str, date, datetime, int, float, bool, decimal.Decimal, None, list, tuple, bytes, io.FileIO, io.BufferedReader | frozendict.frozendict, str, BoolClass, decimal.Decimal, NoneClass, tuple, bytes, FileIO | any string name can be used but the value must be the correct type | [optional]

#### exchange.ApiResponseFor403
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
