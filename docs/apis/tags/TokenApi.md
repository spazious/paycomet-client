<a name="__pageTop"></a>
# paycomet_client.apis.tags.token_api.TokenApi

All URIs are relative to *https://rest.paycomet.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**add_token**](#add_token) | **post** /v1/token | Tokenizes an APM.

# **add_token**
<a name="add_token"></a>
> {str: (bool, date, datetime, dict, float, int, list, str, none_type)} add_token()
...
from paycomet_client.apis.tags import token_api
...
with paycomet_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Tokenizes an APM.
        api_response = api_instance.add_token(
...
------------ | ------------- | ------------- | ------------- | -------------
**methodId** | decimal.Decimal, int,  | decimal.Decimal,  | PAYCOMET payment method ID. | 
**terminal** | decimal.Decimal, int,  | decimal.Decimal,  | Product or terminal Id. | 
**order** | str,  | str,  | Reference, will be included in callback. | 
...
200 | [ApiResponseFor200](#add_token.ApiResponseFor200) | Created
422 | [ApiResponseFor422](#add_token.ApiResponseFor422) | Unprocessable Entity

#### add_token.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
