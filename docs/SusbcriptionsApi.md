...
body = paycomet_client.OrderEditBody() # OrderEditBody |  (optional)
...
paycomet_api_token = 'paycomet_api_token_example' # str | PAYCOMET API key (Authorization privilege required)
order = 'order_example' # str | 
body = paycomet_client.OrderInfoBody1() # OrderInfoBody1 |  (optional)
...
paycomet_api_token = 'paycomet_api_token_example' # str | PAYCOMET API key (Authorization privilege required)
order = 'order_example' # str | 
body = paycomet_client.OrderRemoveBody() # OrderRemoveBody |  (optional)
